...
the fresh paired STRIDER v4 bank; hollow points use the earlier sealed
...
SAIL-inspired and AWE-proxy points are explicitly colored and annotated; the
asterisk identifies frozen-policy proxies rather
...
\begin{figure*}[t]
  ...
  50-seed final bank. Filled points share the fresh paired STRIDER v4 bank;
