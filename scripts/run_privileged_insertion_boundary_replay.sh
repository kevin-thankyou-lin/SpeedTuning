...
controller=/dev/shm/speedtuning-r3-tea-insertion-causal-azlgnAya/insertion/configs/repair-two-segment-downstream1_0.json
...
summary = {
    "schema": "speedtuning-privileged-phase-boundary-replay-audit-v1",
    "task": result["task"],
    "seeds": result["seeds"],
    ...
    "per_seed": [
        {
            ...
            "controller_events": item["controller_events"],
        }
